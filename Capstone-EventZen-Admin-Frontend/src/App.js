...
// EventZen React themes
import theme from "assets/theme";
import themeRTL from "assets/theme/theme-rtl";

// EventZen React Dark Mode themes
...
// EventZen React routes
import routes from "routes";

// EventZen React contexts
...
// Auth routes that should NOT be protected (public pages)
  ...
  return direction === "rtl" ? (
    <CacheProvider value={rtlCache}>
      <ThemeProvider theme={darkMode ? themeDarkRTL : themeRTL}>
        <CssBaseline />
        {layout === "dashboard" && !isPublicRoute && (
          <>
            <Sidenav
              color={sidenavColor}
        ...
        <Routes>
          ...
          {getRoutes(routes)}
          {/* Fallback: go to landing if unmatched */}
